        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await update.message.edit(
                        text="Sorry Sir, You are Banned. Contact My [Support Group](https://t.me/MEGAHUBBOTS)",
                ...
                await update.message.edit(
                    text="Something Went Wrong. Contact My [Support Group](https://t.me/MEGAHUBBOTS)",
                    disable_web_page_preview=True
                )
                return
        await update.message.edit(
